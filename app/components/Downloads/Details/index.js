...
import bigProgress from '../../common/images/bigProgress.svg';
    ...
    return (
      <DetailsWrapper>
        <Field>
          ...
          <ProgressField>
            <ProgressName>{trans('details.Downloaded')}</ProgressName>
            <ProgressBar src={bigProgress} />
            <ProgressCount>30.01%</ProgressCount>
          </ProgressField>
          <Column>
            <Row>
              <HalfFlexA>
                ...
                <ThirdFlex>
                  ...
                  <HalfFlex><p>{trans('details.Downloaded')}</p></HalfFlex>
                  <HalfFlexDetail><p>1.2 Gb</p></HalfFlexDetail>
                  <HalfFlex><p>{trans('details.DownloadSpeed')}</p></HalfFlex>
